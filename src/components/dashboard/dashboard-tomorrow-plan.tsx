...
export function DashboardTomorrowPlan({
  ...
  return (
    <section
      className="dash-tomorrow dash-card"
      data-testid="dashboard-tomorrow-plan"
      aria-labelledby="dashboard-tomorrow-heading"
    >
      <header className="dash-card__header dash-header--numbered">
        ...
        <div>
          ...
          <p className="dash-card__lead">Watch, triggers, and avoid rules for the next session</p>
        </div>
      </header>
